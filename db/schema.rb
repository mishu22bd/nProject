...
ActiveRecord::Schema.define(:version => 20140807061718) do
  ...
  create_table "boxelements", :force => true do |t|
  ...
  add_index "contacts", ["assigned_to_id"], :name => "index_contacts_on_assigned_to_id"
  add_index "contacts", ["author_id"], :name => "index_contacts_on_author_id"
  add_index "contacts", ["company"], :name => "index_contacts_on_company"
  add_index "contacts", ["first_name"], :name => "index_contacts_on_first_name"
  add_index "contacts", ["is_company"], :name => "index_contacts_on_is_company"
  ...
  add_index "contacts_deals", ["deal_id", "contact_id"], :name => "index_contacts_deals_on_deal_id_and_contact_id"

  create_table "contacts_issues", :id => false, :force => true do |t|
    t.integer "issue_id",   :default => 0, :null => false
    t.integer "contact_id", :default => 0, :null => false
  end

  add_index "contacts_issues", ["issue_id", "contact_id"], :name => "index_contacts_issues_on_issue_id_and_contact_id"
  ...
  add_index "contacts_projects", ["project_id", "contact_id"], :name => "index_contacts_projects_on_project_id_and_contact_id"

  create_table "contacts_queries", :force => true do |t|
    t.integer "project_id"
    t.string  "name",          :default => "",    :null => false
    t.text    "filters"
  ...
  create_table "contacts_settings", :force => true do |t|
    t.string   "name"
    t.text     "value"
    t.integer  "project_id"
    t.datetime "updated_on"
  ...
  add_index "contacts_settings", ["project_id"], :name => "index_contacts_settings_on_project_id"
  ...
  create_table "custom_workflows", :force => true do |t|
    t.text    "before_save",                    :null => false
    t.text    "after_save",                     :null => false
    t.string  "name",        :default => "",    :null => false
  ...
  create_table "custom_workflows_projects", :id => false, :force => true do |t|
    t.integer "project_id"
    t.integer "custom_workflow_id"
  end

  add_index "custom_workflows_projects", ["custom_workflow_id"], :name => "index_custom_workflows_projects_on_custom_workflow_id"
  add_index "custom_workflows_projects", ["project_id"], :name => "index_custom_workflows_projects_on_project_id"
  ...
  add_index "deal_categories", ["project_id"], :name => "index_deal_categories_on_project_id"
  ...
  add_index "deal_processes", ["author_id"], :name => "index_deal_processes_on_author_id"
  add_index "deal_processes", ["deal_id"], :name => "index_deal_processes_on_deal_id"
  ...
  create_table "deal_statuses_projects", :id => false, :force => true do |t|
    t.integer "project_id",     :default => 0, :null => false
    t.integer "deal_status_id", :default => 0, :null => false
  end

  add_index "deal_statuses_projects", ["project_id", "deal_status_id"], :name => "index_deal_statuses_projects_on_project_id_and_deal_status_id"
  ...
  add_index "deals", ["author_id"], :name => "index_deals_on_author_id"
  add_index "deals", ["category_id"], :name => "index_deals_on_category_id"
  add_index "deals", ["contact_id"], :name => "index_deals_on_contact_id"
  ...
  add_index "departments", ["parent_id", "lft", "rgt"], :name => "index_departments_on_parent_id_and_lft_and_rgt"
  ...
  create_table "linked_files", :force => true do |t|
    t.integer  "boxelement_id", :null => false
  ...
  add_index "linked_files", ["boxelement_id"], :name => "index_linked_files_on_boxelement_id"
  ...
  add_index "notes", ["source_id", "source_type"], :name => "index_notes_on_source_id_and_source_type"
  ...
  add_index "recently_vieweds", ["viewed_id", "viewed_type"], :name => "index_recently_vieweds_on_viewed_id_and_viewed_type"
  add_index "recently_vieweds", ["viewer_id"], :name => "index_recently_vieweds_on_viewer_id"
  ...
  create_table "todo_items", :force => true do |t|
    ...
    t.datetime "updated_at",   :default => '2014-12-29 11:51:04'
    t.datetime "completed_at", :default => '2014-12-29 11:51:04'
    t.integer  "position",     :default => 1
  end
