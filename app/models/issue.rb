...
class Issue < ActiveRecord::Base
  ...
  scope :project_wise_tasks,  self.where(tracker_id: 4)
  scope :project_wise_issues,  self.where(tracker_id: 5)
  ...
  validates_presence_of :subject, :priority, :project, :tracker, :author, :status, :assigned_to_id, :start_date, :due_date
